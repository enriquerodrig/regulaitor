...
**Run:** 2026-05-24T21:42:57.776786+00:00 | **Commit:** `f2d10eb` | **Models:** claude-sonnet-4-6 (prod), claude-haiku-4-5-20251001 (judge)
...
| latency_p95_ms | 33422 | ≤12000 ❌ (+21422) | (info) |
| chat_latency_p95_ms | 33422 | (info) | (info) |
...
- **Latency**: 31093 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 27468 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 27765 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 26796 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 27375 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
