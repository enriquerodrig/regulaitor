...
**Run:** 2026-05-25T04:43:40.050126+00:00 | **Commit:** `f2d10eb` | **Models:** claude-sonnet-4-6 (prod), claude-haiku-4-5-20251001 (judge)
...
| latency_p95_ms | 343170 | ≤12000 ❌ (+331170) | (info) |
| chat_latency_p95_ms | 343170 | (info) | (info) |
...
- **Latency**: 334344 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
  - ❌ Cita literalmente el artículo 6.1 del AI Act o su contenido sustancial — La respuesta actual está vacía; no contiene ninguna cita ni referencia al artículo 6.1.
  - ❌ Identifica correctamente los dos requisitos acumulativos: componente de seguridad en producto de la lista del Anexo I + evaluación de conformidad por terceros — La respuesta actual está vacía; no identifica ningún requisito.
  - ❌ No afirma obligaciones adicionales no respaldadas por el artículo 6.1 — La respuesta actual está vacía; no es posible evaluar si contiene afirmaciones no respaldadas.
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 321735 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
  - ❌ Cita el artículo 6.2 como regla general de clasificación por Anexo III — La respuesta actual está vacía; no cita ningún artículo.
  - ❌ Explica la excepción del artículo 6.3 sin omitir el requisito de documentación motivada — La respuesta actual está vacía; no contiene explicación alguna de la excepción ni del requisito de documentación.
  - ❌ No afirma que la excepción es automática ni que exime de todos los controles — La respuesta actual está vacía; no hay afirmaciones que evaluar sobre automaticidad o exención de controles.
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 320468 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 319985 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
  - ❌ Cita los artículos 10.1 y 10.2 del AI Act con su contenido sustancial — La respuesta actual está vacía; no cita ningún artículo. El campo cited_articles está vacío y no contiene 10.1 ni 10.2.
  - ❌ Menciona los requisitos de representatividad, pertinencia y libre de errores de los datasets — La respuesta actual está vacía; no menciona ningún requisito de datasets.
  - ❌ Identifica la obligación de gobernanza que incluye detección y corrección de sesgos — La respuesta actual está vacía; no identifica ninguna obligación de gobernanza ni medidas de sesgo.
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 320672 ms | **Cost**: 0.0000 € | **Cache hit**: False
- **Criteria**:
