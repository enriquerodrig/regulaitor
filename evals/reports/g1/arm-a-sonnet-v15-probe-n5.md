...
**Run:** 2026-07-14T08:43:32.098127+00:00 | **Commit:** `148b514` | **Models:** claude-sonnet-4-6 (prod), claude-haiku-4-5-20251001 (judge)
**Settings:** temperature=0.0, subset=full, cache hits/misses: 0/5 | **Total cost:** 0.26 €
...
| latency_p95_ms | 539294 | ≤12000 ❌ (+527294) | (info) |
| chat_latency_p95_ms | 539294 | (info) | (info) |
| doc_latency_p95_ms | 0 | (info) | (info) |
| cost_per_chat_eur | 0.053 | ≤0.05 ❌ (+0.003) | (info) |
| cost_per_doc_eur | 0.000 | ≤0.50 ✅ | (info) |
| cost_total_eur | 0.26 | (info) | (info) |
...
- **Latency**: 511141 ms | **Cost**: 0.0477 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 470922 ms | **Cost**: 0.0522 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 435515 ms | **Cost**: 0.0606 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 439000 ms | **Cost**: 0.0466 € | **Cache hit**: False
- **Criteria**:
...
- **RAG metrics**: faithfulness=0.00 answer_relevancy=0.00 context_precision=0.00 context_recall=0.00
- **Latency**: 401547 ms | **Cost**: 0.0572 € | **Cache hit**: False
- **Criteria**:
