#!/usr/bin/env python
"""T1 Deliverable: Merge v0.1.25 probe (5 cases) + main (25 cases) into v0.1.25-prod.md

Reads:
  - evals/reports/v0.1.25/probe.md (chat-001..005)
  - evals/reports/v0.1.25/v0.1.25-prod-main.md (chat-006..030)

Merges into:
  - evals/reports/v0.1.25/v0.1.25-prod.md (30 cases combined)
...
def main():
    ...
    probe_path = Path("evals/reports/v0.1.25/probe.md")
    main_path = Path("evals/reports/v0.1.25/v0.1.25-prod-main.md")
    output_path = Path("evals/reports/v0.1.25/v0.1.25-prod.md")
