...
- **H15.2** Eval rede-design para measurability del tuning lever del retriever. *(Insertado post-H15.1 — consecuente del design-defect §22.22 disclosed en T10/T11 de H15.1; user-approved POST-SPEND; decimal sin renumerar, precedente H0.1+H15.1. **Planificado, no ejecutado**. Decisión de roadmap aprobada 2026-05-20, ver `docs/technical_decisions_log.md` §H15.2.)*
