...
| **v0.1.29** | `v0.1.29-chat-016-all-blocked-softening` | (no spec; light pattern per v0.1.24.1; fully derived from ADR-0032) | (no plan; mini-plan in commit body) | [0034](adr/0034-all-blocked-routing-softening.md) | `<squash-sha>` |
