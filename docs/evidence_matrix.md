...
`v0.1.6-h15.1` (squash `<squash-sha>` post-merge — decimal optimization
milestone, precedent H0.1).
...
**TFM defense memoria backbone**: [`docs/technical_decisions_log.md`](technical_decisions_log.md) (3407 lines as of H15.1 closure; every approved technical decision from H0 to H15.1).
...
| **H15.1** | `v0.1.6-h15.1` | [spec](superpowers/specs/2026-05-19-h15-1-retriever-optimization-design.md) | [plan](superpowers/plans/2026-05-19-h15-1-retriever-optimization.md) | [0017](adr/0017-retriever-cross-corpus-auto.md) | `<squash-sha>` |
...
| 9 | ADRs current | 0001-0017 (17 ADRs) | ✅ |
...
| H15.2 eval rede-design for tuning-lever measurability | H15.1 §22.22 design-defect disclosed POST-SPEND (T10/T11) | **H15.2 (NEW, user-approved POST-SPEND)** | Decimal sibling of H15.1 (no renumber, precedent H0.1 + H15.1 itself). Scope = extend gold with auto-path cases at N significant OR introduce methodology that measures explicit-path behavior without violating the no-leakage byte-identical guarantee (research question). The §4 design defect must be resolved before any further paid A/B on `RetrievalConfig` levers is meaningful. |
